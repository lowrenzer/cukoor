...
<form id="theform" data-parsley-validate class="form-horizontal form-label-left" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Posisi</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<p required="required" class="form-control col-md-7 col-xs-12" cols="5" name="alamat" data-parsley-error-message="Field ini harus diisi" readonly><a href="https://www.google.co.id/maps/place/<?php echo $result['ll'];?>" ><?php echo $result['ll'];?></p>
			</div>
	</div>
	</form>
