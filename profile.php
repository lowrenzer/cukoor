...
if(isset($_POST['updateprofile'])){
  ...
  $email=$_POST['email'];
  $ll=$_POST['ll'];
	$sql="UPDATE member SET nama_user='$name',telp='$mobileno',alamat='$address', ll='$ll' WHERE email='$email'";
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post" name="theform" onSubmit="return checkLetter(this);">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="ll" value="<?php echo htmlentities($result['ll']);?>" id="ll" type="text" min="0" required>
            </div>
<?php } ?>
            <div class="form-group">
