...
<section class="about_us section-padding">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Reza Pahlevi</h5>
      <p class="card-text">18050974009</p>
    </div>
    <img src="assets/images/3.png" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Alief Fathur R</h5>
      <p class="card-text">18050974017</p>
    </div>
  </div>
  <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Prambayu Rehyta M.</h5>
      <p class="card-text">18050974019</p>
    </div>
  </div>
  <div class="card">
    <img src="assets/images/1.png" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Erlangga Syahputra</h5>
      <p class="card-text">18050974025</p>
    </div>
  </div>
</div>
    </div>
